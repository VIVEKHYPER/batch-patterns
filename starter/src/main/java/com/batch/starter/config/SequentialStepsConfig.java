...
public class SequentialStepsConfig {
	...
	@Bean ItemWriter<UserDetailsDTO> dbWriter(DataSource dataSource) {
		...
		ItemPreparedStatementSetter<UserDetailsDTO> itemPreparedStatementSetter = (item, ps) -> {
	...
	@Bean
	public Job createUserDetailsSSJob(JobBuilderFactory jobBuilderFactory) {
		return jobBuilderFactory
				.get("createUserDetailsSSJob")
